        ...
        if (data) {
            this.mapMarkers = data.map(shelter => ({
                location: {
                    ...
                    Country: shelter.Address__Country__s,
                    PostalCode: shelter.Address__PostalCode__s,
                    State: shelter.Address__State__s,
                    Street: shelter.Address__Street__s,
                },

                title: shelter.Name,

                description: `Street: ${shelter.Address__Street__s}<br>
                              Email: ${shelter.Email__c}<br>
                              Phone: ${shelter.Phone__c}`,
